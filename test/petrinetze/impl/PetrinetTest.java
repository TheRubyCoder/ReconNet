...
public class PetrinetTest {
    ...
    public void simpleNet() {
        ...
        final Place p1 = p.createPlace("p1");

        l.assertChanged();
        l.assertLastChangeIs(p1, ActionType.added);

        final Place p2 = p.createPlace("p2");

        l.assertChanged();
        l.assertLastChangeIs(p2, ActionType.added);


        final Transition t1 = p.createTransition("t1");

        l.assertChanged();
        l.assertLastChangeIs(t1, ActionType.added);

        final Transition t2 = p.createTransition("t2");

        l.assertChanged();
        l.assertLastChangeIs(t2, ActionType.added);

        final Arc p1t1 = p.createArc("p1t1", p1, t1);
        ...
        final Arc t1p2 = p.createArc("t1p2", t1, p2);
        ...
        final Arc p2t2 = p.createArc("p2t2", p2, t2);
        ...
        final Arc t2p1 = p.createArc("t2p1", t2, p1);
        l.assertChanged();
    ...
    public void activation() {
        ...
        final Place p1 = net.createPlace("p1");
        final Place p2 = net.createPlace("p2");

        final Transition t1 = net.createTransition("t1");
