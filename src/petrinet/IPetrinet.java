...
public interface IPetrinet {
	...
	/**
	 * removes an element (Place, Transition, Arc) from a petrinet
	 * 
	 * @param petrinetId
	 *            id of petrinet
	 * @param elementId
	 *            id of element
	 * @return A Collection of all elements (their ids) that got removed
	 * @example a transition (id: 1) with 4 adjacent arcs(id 2-5) is removed.<br/>
