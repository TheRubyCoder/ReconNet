...
public interface GraphEditor {
     ...
     * wird die Kante nicht erzeugt und es wird null zurÃ¼ck gegeben
     *
     * @param from
     * @param to
     *
     * @return Kante zwischen Transition und Stelle oder null falls vorbindung nicht erfÃ¼llt
     */
    IArc createArc(INode from, INode to);

    /**
     * Entfernen der ï¿½bergegebenen Knoten.
     *
    ...
    /**
     * Gibt das JPanel zum Anzeigen des Graphen zurÃ¼ck
